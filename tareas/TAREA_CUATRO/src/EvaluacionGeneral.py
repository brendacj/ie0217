class EvaluacionGeneral():
    ...
    el porcentaje de alergias encontradas y mostrar los
    ...
    def calcularPuntuacion(self, listaFinal):
        """
        Calcula la puntuación total sumando los valores de las
        alergias presentes en la lista final.
    ...
    def calcularPromedio(self, total, encontrados):
        """
        Calcula y muestra el porcentaje de alergias encontradas
        ...
        try:
            ...
            print("El porcentaje de alergias encontradas fue: "
                  + str(porcentaje) + "%")
        except ZeroDivisionError:
            print("No hay alergias registradas")
